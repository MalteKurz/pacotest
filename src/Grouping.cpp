...
// Learn the first split
    ...
    if (m>1 && (n >= 1000 || (n>= 500 && l == 1))) //From the third tree on, i.e., if the dimension of the conditioning set is larger than two, a second split is performed
    {
        ...
        arma::mat U1_1_1(n3,2);
        arma::mat U1_1_2(n1-n3,2);
        ...
        arma::mat U1_2_1(n4,2);
        arma::mat U1_2_2(n2-n4,2);
