...
test_that("unit tests for ECORR", {
  ...
  expect_equal(resultData1Test1,2.1246893133763933292e-12, tolerance = 1e-2)
  expect_equal(resultData2Test1,0.63520407773957221487, tolerance = 1e-2)
  expect_equal(resultData3Test1,5.752268106284930127e-10, tolerance = 1e-2)
  expect_equal(resultData4Test1,0.28687570821890190365, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test2,1.9217960556261459715e-13, tolerance = 1e-2)
  expect_equal(resultData2Test2,0.44452957033286516486, tolerance = 1e-2)
  expect_equal(resultData3Test2,9.6432739571383763177e-10, tolerance = 1e-2)
  expect_equal(resultData4Test2,0.4467445460704165261, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test3,1.1102230246251565404e-15, tolerance = 1e-2)
  expect_equal(resultData2Test3,0.5580923850607153458, tolerance = 1e-2)
  expect_equal(resultData3Test3,2.3669399773496024864e-12, tolerance = 1e-2)
  expect_equal(resultData4Test3,0.23216541288975905966, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test4,3.3317792969000947778e-13, tolerance = 1e-2)
  expect_equal(resultData2Test4,0.47397446101156270881, tolerance = 1e-2)
  expect_equal(resultData3Test4,4.0479203322618673155e-10, tolerance = 1e-2)
  expect_equal(resultData4Test4,0.24323996217835758271, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test5,1.8540724511240114225e-14, tolerance = 1e-2)
  expect_equal(resultData2Test5,0.38342942676277014247, tolerance = 1e-2)
  expect_equal(resultData3Test5,0.029434655647674223822, tolerance = 1e-2)
  expect_equal(resultData4Test5,0.98048071162177008464, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test6,5.3219144424687669925e-07, tolerance = 1e-2)
  expect_equal(resultData2Test6,0.35321452437203049168, tolerance = 1e-2)
  expect_equal(resultData3Test6,4.8030468491333522252e-12, tolerance = 1e-2)
  expect_equal(resultData4Test6,0.11816799466211991287, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test7,0, tolerance = 1e-2)
  expect_equal(resultData2Test7,0.37068998206199255119, tolerance = 1e-2)
  expect_equal(resultData3Test7,0.85332915470892367615, tolerance = 1e-2)
  expect_equal(resultData4Test7,0.20442665798885406581, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test8,1.1429746038515986584e-13, tolerance = 1e-2)
  expect_equal(resultData2Test8,0.59295520957221348191, tolerance = 1e-2)
  expect_equal(resultData3Test8,3.9912728677649056408e-10, tolerance = 1e-2)
  expect_equal(resultData4Test8,0.23679788942968227339, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test9,5.4373172631017041567e-13, tolerance = 1e-2)
  expect_equal(resultData2Test9,0.53315281445507345381, tolerance = 1e-2)
  expect_equal(resultData3Test9,8.0054185502831387566e-10, tolerance = 1e-2)
  expect_equal(resultData4Test9,0.35183868648104549282, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test10,1.6098233857064769836e-15, tolerance = 1e-2)
  expect_equal(resultData2Test10,0.619130004810437784, tolerance = 1e-2)
  expect_equal(resultData3Test10,1.8795520695391587651e-12, tolerance = 1e-2)
  expect_equal(resultData4Test10,0.20706972655040151166, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test11,2.6623148130511253839e-13, tolerance = 1e-2)
  expect_equal(resultData2Test11,0.50311142788708784757, tolerance = 1e-2)
  expect_equal(resultData3Test11,6.250877593316772618e-10, tolerance = 1e-2)
  expect_equal(resultData4Test11,0.21746320138389635401, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test12,2.5190405317232489324e-12, tolerance = 1e-2)
  expect_equal(resultData2Test12,0.55176889867673017953, tolerance = 1e-2)
  expect_equal(resultData3Test12,1.0080859480510184767e-09, tolerance = 1e-2)
  expect_equal(resultData4Test12,0.26489140864933702346, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test13,1.85873538782743708e-12, tolerance = 1e-2)
  expect_equal(resultData2Test13,0.40894465103703903086, tolerance = 1e-2)
  expect_equal(resultData3Test13,5.4038018504343199311e-10, tolerance = 1e-2)
  expect_equal(resultData4Test13,0.32368124043977708482, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test14,8.5487172896137053613e-15, tolerance = 1e-2)
  expect_equal(resultData2Test14,0.55045671042871491263, tolerance = 1e-2)
  expect_equal(resultData3Test14,3.2835401064801317261e-12, tolerance = 1e-2)
  expect_equal(resultData4Test14,0.25056714373550648123, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test15,4.0872860651575138036e-13, tolerance = 1e-2)
  expect_equal(resultData2Test15,0.41687690526596948848, tolerance = 1e-2)
  expect_equal(resultData3Test15,3.4853187003136554267e-10, tolerance = 1e-2)
  expect_equal(resultData4Test15,0.25563507291861059523, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test16,3.4767189127649089642e-12, tolerance = 1e-2)
  expect_equal(resultData2Test16,0.50423600959622016937, tolerance = 1e-2)
  expect_equal(resultData3Test16,2.1512736037010427026e-10, tolerance = 1e-2)
  expect_equal(resultData4Test16,0.20040253398187107825, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test17,1.0745848655346890155e-12, tolerance = 1e-2)
  expect_equal(resultData2Test17,0.5523203441913488998, tolerance = 1e-2)
  expect_equal(resultData3Test17,9.9395125463530575871e-10, tolerance = 1e-2)
  expect_equal(resultData4Test17,0.2985501716539057937, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test18,3.8302694349567900645e-15, tolerance = 1e-2)
  expect_equal(resultData2Test18,0.58424540728909668541, tolerance = 1e-2)
  expect_equal(resultData3Test18,1.4301781980918804038e-11, tolerance = 1e-2)
  expect_equal(resultData4Test18,0.17916966243283055649, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test19,1.1696199564426024153e-12, tolerance = 1e-2)
  expect_equal(resultData2Test19,0.47242161671558513536, tolerance = 1e-2)
  expect_equal(resultData3Test19,8.8058427216708423657e-10, tolerance = 1e-2)
  expect_equal(resultData4Test19,0.18836423784367994916, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test20,0, tolerance = 1e-2)
  expect_equal(resultData2Test20,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test20,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test20,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test21,0, tolerance = 1e-2)
  expect_equal(resultData2Test21,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test21,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test21,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test22,0, tolerance = 1e-2)
  expect_equal(resultData2Test22,0.55145510054908453146, tolerance = 1e-2)
  expect_equal(resultData3Test22,2.2204460492503130808e-16, tolerance = 1e-2)
  expect_equal(resultData4Test22,0.053177235107229048339, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test23,0, tolerance = 1e-2)
  expect_equal(resultData2Test23,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test23,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test23,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test24,0, tolerance = 1e-2)
  expect_equal(resultData2Test24,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test24,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test24,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test25,0, tolerance = 1e-2)
  expect_equal(resultData2Test25,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test25,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test25,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test26,0, tolerance = 1e-2)
  expect_equal(resultData2Test26,0.55145510054908453146, tolerance = 1e-2)
  expect_equal(resultData3Test26,2.2204460492503130808e-16, tolerance = 1e-2)
  expect_equal(resultData4Test26,0.053177235107229048339, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test27,0, tolerance = 1e-2)
  expect_equal(resultData2Test27,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test27,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test27,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test28,0, tolerance = 1e-2)
  expect_equal(resultData2Test28,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test28,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test28,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test29,0, tolerance = 1e-2)
  expect_equal(resultData2Test29,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test29,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test29,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test30,0, tolerance = 1e-2)
  expect_equal(resultData2Test30,0.55145510054908453146, tolerance = 1e-2)
  expect_equal(resultData3Test30,2.2204460492503130808e-16, tolerance = 1e-2)
  expect_equal(resultData4Test30,0.053177235107229048339, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test31,0, tolerance = 1e-2)
  expect_equal(resultData2Test31,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test31,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test31,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test32,0, tolerance = 1e-2)
  expect_equal(resultData2Test32,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test32,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test32,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test33,0, tolerance = 1e-2)
  expect_equal(resultData2Test33,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test33,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test33,0.98048071162180483462, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test34,0, tolerance = 1e-2)
  expect_equal(resultData2Test34,0.55145510054908453146, tolerance = 1e-2)
  expect_equal(resultData3Test34,2.2204460492503130808e-16, tolerance = 1e-2)
  expect_equal(resultData4Test34,0.053177235107229048339, tolerance = 1e-2)
  ...
  expect_equal(resultData1Test35,0, tolerance = 1e-2)
  expect_equal(resultData2Test35,0.38342942676277114167, tolerance = 1e-2)
  expect_equal(resultData3Test35,1.4357270927689569362e-10, tolerance = 1e-2)
  expect_equal(resultData4Test35,0.98048071162180483462, tolerance = 1e-2)
...
test_that("unit tests for ECOV, EC and VI", {
  ...
  expect_equal(resultData6Test1,0.70699999999999996181, tolerance = 1e-2)
  expect_equal(resultData6Test2,0.57099999999999995204, tolerance = 1e-2)
  expect_equal(resultData6Test3,0.8329999999999999627, tolerance = 1e-2)
  expect_equal(resultData6Test4,0.35899999999999998579, tolerance = 1e-2)
  expect_equal(resultData6Test5,0.4697714112048757551, tolerance = 1e-2)
  expect_equal(resultData6Test6,0.32018336201425989795, tolerance = 1e-2)
  expect_equal(resultData6Test7,0.85306274124527348146, tolerance = 1e-2)
  expect_equal(resultData6Test8,0.46977141120487586612, tolerance = 1e-2)
  expect_equal(resultData6Test9,0.46977141120487586612, tolerance = 1e-2)
  expect_equal(resultData6Test10,0.84799768664968644405, tolerance = 1e-2)
  expect_equal(resultData6Test11,0.46977141120487586612, tolerance = 1e-2)
  expect_equal(resultData6Test12,0.46977141120487586612, tolerance = 1e-2)
  expect_equal(resultData6Test13,0.46977141120487586612, tolerance = 1e-2)
  expect_equal(resultData6Test14,0.84799768664968644405, tolerance = 1e-2)
  expect_equal(resultData6Test15,0.46977141120487586612, tolerance = 1e-2)
  expect_equal(resultData6Test16,0.50070969489726790957, tolerance = 1e-2)
  expect_equal(resultData6Test17,0.31251998961408167244, tolerance = 1e-2)
  expect_equal(resultData6Test18,0.8636715705286200917, tolerance = 1e-2)
  expect_equal(resultData6Test19,0.50070969489726846469, tolerance = 1e-2)
  expect_equal(resultData6Test20,0.86678889065076192288, tolerance = 1e-2)
  expect_equal(resultData6Test21,0.50070969489726846469, tolerance = 1e-2)
  expect_equal(resultData6Test22,0.50070969489726846469, tolerance = 1e-2)
  expect_equal(resultData6Test23,0.50070969489726846469, tolerance = 1e-2)
  expect_equal(resultData6Test24,0.86678889065076192288, tolerance = 1e-2)
  expect_equal(resultData6Test25,0.50070969489726846469, tolerance = 1e-2)
